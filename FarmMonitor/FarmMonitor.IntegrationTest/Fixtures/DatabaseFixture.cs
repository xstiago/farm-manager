...
namespace FarmMonitor.IntegrationTest.Fixtures
{
    public class DatabaseFixture : IDisposable
    {
        ...
        private FarmMonitorDbContext CreateDbContext()
        {
            var options = new DbContextOptionsBuilder<FarmMonitorDbContext>().UseNpgsql(_connectionString).Options;
            var context = new FarmMonitorDbContext(options);
